package com.fudfill.runner.slidingmenu.location;
...
public class GPSRunnerTracker extends Service implements LocationListener {
    ...
    private static final String TAG = "GPSRunnerTracker";
    ...
    public void stopUsingGPS() {
        if (locationManager != null) {
            locationManager.removeUpdates(GPSRunnerTracker.this);
        }
    }
